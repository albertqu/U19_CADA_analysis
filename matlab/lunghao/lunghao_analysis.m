function [out] = lunghao_analysis(data_root, animal, session, Hemi_str)
% issue: change filenames all to D1-R35_EMk
warning('off','MATLAB:unknownElementsNowStruc');
warning('off','MATLAB:timer:incompatibleTimerLoad');
clear;

thisfile=[mfilename '_' animal, '_' session];
AnimStrs = split(animal, '_');
fpAnim = [AnimStrs{1} '-' AnimStrs{2}];
matfile_path=[data_root 'TempNew' filesep];
csvfile_path=[data_root 'BSDML_FP' filesep fpAnim filesep];
